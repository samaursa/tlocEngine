...
"Window already exists. Call Close() before calling Create()");
  ...
  template <WINDOW_TEMP>
  void Window_T<WINDOW_PARAMS>::Create()
  {
    DoCreateImpl();
    m_impl->Create();
  }
  ...
  template <WINDOW_TEMP>
  void Window_T<WINDOW_PARAMS>::Close()
  {
    VALIDATE_WINDOW();
  ...
  template <WINDOW_TEMP>
  bool Window_T<WINDOW_PARAMS>::IsCreated() const
  {
    if (IsValid())
  ...
  template <WINDOW_TEMP>
  WINDOW_TYPE::size_type Window_T<WINDOW_PARAMS>::GetWidth() const
  {
    VALIDATE_WINDOW();
  ...
  template <WINDOW_TEMP>
  WINDOW_TYPE::size_type Window_T<WINDOW_PARAMS>::GetHeight() const
  {
    VALIDATE_WINDOW();
  ...
  template <WINDOW_TEMP>
  WINDOW_TYPE::window_handle_type Window_T<WINDOW_PARAMS>::GetWindowHandle() const
  {
    VALIDATE_WINDOW();
  ...
  template <WINDOW_TEMP>
  void Window_T<WINDOW_PARAMS>::SetVerticalSync(bool a_enable)
  {
    VALIDATE_WINDOW();
  ...
  template <WINDOW_TEMP>
  void Window_T<WINDOW_PARAMS>::SetActive(bool a_active) const
  {
    VALIDATE_WINDOW();
  ...
  template <WINDOW_TEMP>
  void Window_T<WINDOW_PARAMS>::SetPosition(s32 a_x, s32 a_y)
  {
    VALIDATE_WINDOW();
  ...
  template <WINDOW_TEMP>
  void Window_T<WINDOW_PARAMS>::SetSize(size_type a_width, size_type a_height)
  {
    VALIDATE_WINDOW();
  ...
  template <WINDOW_TEMP>
  void Window_T<WINDOW_PARAMS>::SetVisibility(bool a_visible)
  {
    VALIDATE_WINDOW();
  ...
  template <WINDOW_TEMP>
  void Window_T<WINDOW_PARAMS>::SendEvent(const WindowEvent& a_event)
  {
  ...
  template <WINDOW_TEMP>
  void Window_T<WINDOW_PARAMS>::DoCreateImpl()
  {
    VALIDATE_NOT_WINDOW();
