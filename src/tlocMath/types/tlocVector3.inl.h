...
#define VECTOR_3_PARAMS T, 3
    ...
    Cross(const this_type& aVector) const
  {
    ...
    */
    ...
    temp.m_values[0] = this->m_values[1] * aVector[2] - m_values[2] * aVector[1];
    temp.m_values[1] = this->m_values[2] * aVector[0] - m_values[0] * aVector[2];
    temp.m_values[2] = this->m_values[0] * aVector[1] - m_values[1] * aVector[0];
