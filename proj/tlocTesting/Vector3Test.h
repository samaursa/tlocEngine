...
TEST_CASE_METHOD(Vector3fFixture, "Math/Vector3f/[]Operator", "Tests the "
                 "square bracket operator value retrieval and assignment")
{
...
TEST_CASE_METHOD(Vector3fFixture, "Math/Vector3f/SetAndZero", "Tests the "
                 "Set() and Zero() functions")
{
  a.Set(1);
