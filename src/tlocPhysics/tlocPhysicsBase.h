...
#define TLOC_LOG_PHYS_SUCCESS() TLOC_LOG_SUCCESS(&tloc::physics::GetLogger())
...
#define TLOC_LOG_PHYS_SUCCESS_IF(_expr_) TLOC_LOG_SUCCESS_IF(_expr_, &tloc::physics::GetLogger())
...
#define TLOC_LOG_PHYS_SUCCESS_FILENAME_ONLY() TLOC_LOG_SUCCESS_FILENAME_ONLY(&tloc::physics::GetLogger())
...
#define TLOC_LOG_PHYS_SUCCESS_FILENAME_ONLY_IF(_expr_) TLOC_LOG_SUCCESS_FILENAME_ONLY_IF(_expr_, &tloc::physics::GetLogger())
...
#define TLOC_LOG_PHYS_SUCCESS_NO_FILENAME() TLOC_LOG_SUCCESS_NO_FILENAME(&tloc::physics::GetLogger())
...
#define TLOC_LOG_PHYS_SUCCESS_NO_FILENAME_IF(_expr_) TLOC_LOG_SUCCESS_NO_FILENAME_IF(_expr_, &tloc::physics::GetLogger())
