...
TLOC_EXTERN_TEMPLATE_ALL_SMART_PTRS(tloc::gfx_cs::DynamicTextRenderSystem);
TLOC_EXTERN_TEMPLATE_VIRTUAL_STACK_OBJECT_NO_COPY_CTOR_NO_DEF_CTOR(tloc::gfx_cs::DynamicTextRenderSystem);
