...
#define TLOC_EXTERN_TEMPLATE_SCALE(_type1_, _type2_)\
  TLOC_EXTERN_TEMPLATE_CLASS(Scale_T<_type1_ TLOC_COMMA _type2_ TLOC_COMMA f64>);\
  TLOC_EXTERN_TEMPLATE_CLASS(Scale_T<_type1_ TLOC_COMMA _type2_ TLOC_COMMA f32>)

#define TLOC_EXTERN_TEMPLATE_SCALE_ALL_TYPES(_type_)\
  TLOC_EXTERN_TEMPLATE_SCALE(_type_, s8);\
  TLOC_EXTERN_TEMPLATE_SCALE(_type_, s16);\
  TLOC_EXTERN_TEMPLATE_SCALE(_type_, s32);\
  TLOC_EXTERN_TEMPLATE_SCALE(_type_, s64);\
  TLOC_EXTERN_TEMPLATE_SCALE(_type_, u8);\
  TLOC_EXTERN_TEMPLATE_SCALE(_type_, u16);\
  TLOC_EXTERN_TEMPLATE_SCALE(_type_, u32);\
  TLOC_EXTERN_TEMPLATE_SCALE(_type_, u64);\
  TLOC_EXTERN_TEMPLATE_SCALE(_type_, f32);\
  TLOC_EXTERN_TEMPLATE_SCALE(_type_, f64);\
  TLOC_EXTERN_TEMPLATE_SCALE(_type_, tl_size)

  TLOC_EXTERN_TEMPLATE_SCALE_ALL_TYPES(s8);
  TLOC_EXTERN_TEMPLATE_SCALE_ALL_TYPES(s16);
  TLOC_EXTERN_TEMPLATE_SCALE_ALL_TYPES(s32);
  TLOC_EXTERN_TEMPLATE_SCALE_ALL_TYPES(s64);
  TLOC_EXTERN_TEMPLATE_SCALE_ALL_TYPES(u8);
  TLOC_EXTERN_TEMPLATE_SCALE_ALL_TYPES(u16);
  TLOC_EXTERN_TEMPLATE_SCALE_ALL_TYPES(u32);
  TLOC_EXTERN_TEMPLATE_SCALE_ALL_TYPES(u64);
  TLOC_EXTERN_TEMPLATE_SCALE_ALL_TYPES(f32);
  TLOC_EXTERN_TEMPLATE_SCALE_ALL_TYPES(f64);
