...
#define TLOC_LOG_INPUT_SUCCESS() TLOC_LOG_SUCCESS(&tloc::input::GetLogger())
...
#define TLOC_LOG_INPUT_SUCCESS_IF(_expr_) TLOC_LOG_SUCCESS_IF(_expr_, &tloc::input::GetLogger())
...
#define TLOC_LOG_INPUT_SUCCESS_FILENAME_ONLY() TLOC_LOG_SUCCESS_FILENAME_ONLY(&tloc::input::GetLogger())
...
#define TLOC_LOG_INPUT_SUCCESS_FILENAME_ONLY_IF(_expr_) TLOC_LOG_SUCCESS_FILENAME_ONLY_IF(_expr_, &tloc::input::GetLogger())
...
#define TLOC_LOG_INPUT_SUCCESS_NO_FILENAME() TLOC_LOG_SUCCESS_NO_FILENAME(&tloc::input::GetLogger())
...
#define TLOC_LOG_INPUT_SUCCESS_NO_FILENAME_IF(_expr_) TLOC_LOG_SUCCESS_NO_FILENAME_IF(_expr_, &tloc::input::GetLogger())
