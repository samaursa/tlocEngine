#ifndef _TLOC_MATH_INCLUDE_ALL_MATH_INL_
#define _TLOC_MATH_INCLUDE_ALL_MATH_INL_

#ifndef _TLOC_MATH_INCLUDE_ALL_MATH_H_
...
#include <tlocMath/statistics/tloc_statistics.inl.h>
