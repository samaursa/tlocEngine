...
public:
	...
	/// @param rectChoice The free rectangle choice heuristic rule to use.
	/// @param splitMethod The free rectangle split heuristic rule to use.
	void Insert(tloc::core_conts::Array<RectSize> &rects, bool merge, 
	...
	tloc::core_conts::Array<Rect> &GetFreeRectangles() { return freeRectangles; }
	...
	tloc::core_conts::Array<Rect> &GetUsedRectangles() { return usedRectangles; }
